...
struct player {
    ...
    // TODO: share `field` between players. Names may collide. Players may be deleted in arbitrary order. The last player deleted should delete the field.
    std::string field;

    explicit player(std::string name_) : name(std::move(name_)), field(10, '.') {}
